...
Ver [`survey/metodologia.md`](../survey/metodologia.md) para el diseño completo de la encuesta.

**Instrumentos:** Tally form `q4EQX9` (ES) y versión EN (pendiente).  
**Período de recolección:** _por completar_.  
**n =** _por completar_.
...
_Por completar tras análisis. Los notebooks en `analysis/notebooks/` documentan el proceso._

### 3.1 Perfil de respondientes

### 3.2 Distribución de carga horaria por tarea

### 3.3 Tareas percibidas como de bajo valor profesional

### 3.4 Reservas frente a la IA

### 3.5 Impacto económico estimado
...
## 5. Implicancias para la adopción de IA
...
_Este documento es un borrador vivo. La versión final se publicará como PDF en LinkedIn y en este repositorio._
